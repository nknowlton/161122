...
format: 
  revealjs:
    ...
    logo: 660491-ls_black_whitoutunz.png
    include-in-header:
      - text: |
         <style>
          .reveal .slide-logo {
...
# Example: <br> Moroccan donkeys {style="text-align: center;"}

![](donkey.png "Moroccan Donkey")

## Example: Moroccan donkeys
...
plot.out <- g1 + g2 + g3 + g4 + g5 + plot_layout(nrow=1) 
...
```{r boxplot_plot1, echo=FALSE, fig.width=8, fig.height=6, message = FALSE, out.width="85%"}
#| fig-align: center
g1
...
```{r boxplot_plot2, echo=FALSE, fig.width=8, fig.height=6, message = FALSE, out.width="85%"}
#| fig-align: center
g2
...
```{r boxplot_plot3, echo=FALSE, fig.width=8, fig.height=6, message = FALSE, out.width="85%"}
#| fig-align: center
g3
...
```{r boxplot_plot4, echo=FALSE, fig.width=8, fig.height=6, message = FALSE, out.width="85%"}
#| fig-align: center
g4
...
```{r boxplot_plot5, echo=FALSE, fig.width=8, fig.height=6, message = FALSE, out.width="85%"}
#| fig-align: center
g5
...
## Simple linear regression <br> Morocan Donkeys {style="text-align: center;"}
...
$\beta$ is the **slope** the increase in $y$ for a
...
around the regression line as **additive random errors** denoted by $\varepsilon_i$.
...
## Estimation of parameters {.center}
...
## Estimating the parameters {.center}
...
Adjust the proposed line, then reveal the least-squares fit to compare it
with your intuition.
:::
...
import { regressionLab } from "./regression-lab.js"
...
* The estimates $\hat\alpha$ and $\hat\beta$ are chosen to minimize
